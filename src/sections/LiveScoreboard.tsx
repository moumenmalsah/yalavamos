  ...
  return {
    A: {
      teams: [
        ...
        { name: 'Korea Republic', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#CD2E3A' },
        { name: 'Czechia', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#11457E' },
      ],
      nextMatch: 'June 11 — Mexico vs South Africa',
    },
    B: {
      teams: [
        { name: 'Canada', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#FF0000' },
        { name: 'Bosnia & Herz.', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#002395' },
      ...
      nextMatch: 'June 12 — Canada vs Bosnia & Herz.',
    },
    C: {
      teams: [
        ...
        { name: 'Haiti', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#00209F' },
        { name: 'Scotland', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#005EB8' },
      ],
      nextMatch: 'June 13 — Brazil vs Morocco',
    },
    D: {
      teams: [
        ...
        { name: 'Türkiye', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#E30A17' },
      ],
      nextMatch: 'June 12 — USA vs Paraguay',
    },
    E: {
      teams: [
        { name: 'Germany', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#000000' },
        { name: 'Curaçao', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#003DA5' },
      ...
      nextMatch: 'June 14 — Germany vs Curaçao',
    },
    F: {
      teams: [
      ...
      nextMatch: 'June 14 — Netherlands vs Japan',
    },
    G: {
      teams: [
        ...
        { name: 'Iran', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#239F40' },
        { name: 'New Zealand', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#000000' },
      ],
      nextMatch: 'June 15 — Belgium vs Egypt',
    },
    H: {
      teams: [
        { name: 'Spain', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#AA151B' },
        { name: 'Cape Verde', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#003893' },
      ...
      nextMatch: 'June 15 — Spain vs Cape Verde',
    },
    I: {
      teams: [
        ...
        { name: 'Iraq', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#007A3D' },
        { name: 'Norway', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#EF2B2D' },
      ],
      nextMatch: 'June 16 — France vs Senegal',
    },
    J: {
      teams: [
        ...
        { name: 'Austria', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#ED2939' },
        { name: 'Jordan', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#CE1126' },
      ],
      nextMatch: 'June 16 — Argentina vs Algeria',
    },
    K: {
      teams: [
        { name: 'Portugal', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#006600' },
        { name: 'DR Congo', played: 0, wins: 0, draws: 0, losses: 0, gd: 0, points: 0, flagColor: '#007FFF' },
      ...
      nextMatch: 'June 17 — Portugal vs DR Congo',
    },
    L: {
      teams: [
      ...
      nextMatch: 'June 17 — England vs Croatia',
    },
  };
}
